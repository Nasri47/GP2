        ...
        try {
            ...
            if (!baseJsonResponse.optBoolean("error")) {
                ...
                for (int i = 0; i < ownerInfoList.length(); i++) {
                    ...
                    int fieldId = ownerInfoListJSONObject.getInt("user_id");
                    int blockState = ownerInfoListJSONObject.getInt("field_id");
                    String resons = ownerInfoListJSONObject.getString("response");
                    closeField = new FieldInformations(fieldId , blockState , resons);
                }
            }
