...
public class ChangePassUtils {
    ...
    private static final String LOG_TAG = ChangePassUtils.class.getSimpleName();
    private ChangePassUtils() {
    }

    private static ChangePassRespons extractFeatureFromJson(String ownerJSON) {
        ChangePassRespons fieldInfo = new ChangePassRespons();
        ...
        try {
            ...
            if (!baseJsonResponse.optBoolean("error")) {
                ...
                for (int i = 0; i < ownerInfoList.length(); i++) {
                    ...
                    int response = ownerInfoListJSONObject.getInt("respons");
                    fieldInfo = new ChangePassRespons(fieldId , response);
                }
    ...
    public static ChangePassRespons fetchfieldsData(String requestUrl) {
        // Create URL object
        ...
        ChangePassRespons response = extractFeatureFromJson(jsonResponse);
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            params.add(new ParamValues("field_id", ChangePass.fId));
            params.add(new ParamValues("old_pass", ChangePass.oldP));
            params.add(new ParamValues("new_pass", ChangePass.newP));
