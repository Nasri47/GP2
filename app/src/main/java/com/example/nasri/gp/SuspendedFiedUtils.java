...
public class SuspendedFiedUtils {
    ...
    private static FieldInformations extractFeatureFromJson(String fieldsListJSON) {
        ...
        FieldInformations fieldInformations = new FieldInformations() ;
        ...
        try {
            ...
            for (int i = 0; i < fieldsListArray.length(); i++) {
                ...
                int respons = currentEarthquake.getInt("response");
                fieldInformations = new FieldInformations(respons);
            }
